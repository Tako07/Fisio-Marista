@if(session('id_usuario') != null /* SI LA SESION EXISTE MUESTRA EL CONTENIDO */)
    ...
    @section('title,Calendario')
        @section('principal')
            <!-- DEFINICION DE ESTILOS O JS A UTILIZAR -->
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <div class="input-field col s12">
                                        @php
                                        $numCitasAct = 1;
                                        foreach($citas as $cita)$numCitasAct = $numCitasAct+1;
                                        @endphp
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <div class="input-field col s12">
                                        @php
                                        $numCitas = 1;
                                        foreach($citas as $cita)$numCitas = $numCitas+1;
                                        @endphp
                ...
                <script>
                    ...
                    $(document).ready(function () {
                        $('#CalendarioWeb').fullCalendar({
                            ...
                            // OBTENER EL BOTON QUE CIERRA LOS MODAL
                            ...
                            //CUANDO SE DE CLIC EN CUALQUIER AREA QUE NO SEAL EL MODAL
